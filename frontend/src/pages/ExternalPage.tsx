    ...
    <div className="grid">
        ...
        <div className="stack">
          ...
          {llm.isError ? (
            <Alert variant="danger">
              {llm.error instanceof Error ? llm.error.message : 'LLM failed'}
            </Alert>
          ) : null}
      ...
      <Card title="External app integration (/api/external_app)">
        <div className="stack">
          <div className="grid3">
            <Field label="app">
              <Input
                ...
                placeholder="notion | googlesheets | trello | email | webhook"
              />
            </Field>
            <Field label="action">
              <Input
          ...
          {appMutation.isError ? (
            <Alert variant="danger">
              {appMutation.error instanceof Error ? appMutation.error.message : 'Integration failed'}
            </Alert>
          ) : null}
